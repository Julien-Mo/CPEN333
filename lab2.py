...
class Rational:
    ...
    def add(self, secondRational):
        ...
        """     
        # r1 + r2 = (ad + bc)/(bd) where r1 = a/b and r2 = c/d
    ...
    def multiply(self, secondRational):
        """multiplies 'this' rational to secondRational
           returns the result as a rational number (type Rational)
        """ 
        # r1 * r2 = (ac)/(bd) where r1 = a/b and r2 = c/d
    ...
    def divide(self, secondRational):
        """divides 'this' rational by secondRational
           returns the result as a rational number (type Rational)
        """ 
        # r1 / r2 = (ad)/(bc) where r1 = a/b and r2 = c/d
    ...
    def toString(self):
        ...
        # Return NaN if demoninator is 0
        elif self.denominator == 0:
            return "NaN"
        # Return 0 if numerator is 0
        elif self.numerator == 0:
            return "0"
        # return rational number represented as a string
        else:
